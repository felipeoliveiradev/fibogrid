  ...
  return (
    <div className="relative group">
      ...
      <Button
        size="sm"
        variant="ghost"
        className="absolute top-2 right-2 opacity-0 group-hover:opacity-100 transition-opacity hover:bg-primary/10"
        onClick={handleCopy}
      >
                  ...
                  <div className="space-y-8 animate-fade-in">
                    ...
                    <Card className="paper-aged border-primary/10">
                      ...
                      <CardContent className="space-y-4">
                        <p className="font-body">Import the DataGrid component and pass your data:</p>
                        <CodeBlock code={`import { DataGrid } from 'fibogrid';
...
function MyGrid() {
  ...
  aggFunc?: 'sum' | 'avg' | 'min' | 'max' | 'count';
                    ...
                    <Card className="paper-aged border-primary/10">
                      <CardHeader>
                        <CardTitle className="font-display text-xl">Custom Cell Renderer</CardTitle>
                      </CardHeader>
                      <CardContent>
          ...
          {params.value}
                ...
                {activeSection === 'sorting' && (
                  <div className="space-y-8 animate-fade-in">
                    ...
                    <Card className="paper-aged border-primary/10">
                      <CardHeader>
                        <CardTitle className="font-display text-xl">Multi-Column Sort</CardTitle>
                      </CardHeader>
                      <CardContent>
...
/>`} />
                ...
                {activeSection === 'filtering' && (
                  <div className="space-y-8 animate-fade-in">
                    ...
                    <Card className="paper-aged border-primary/10">
                      <CardHeader>
                        <CardTitle className="font-display text-xl">Filter Types</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <CodeBlock code={`const columns: ColumnDef[] = [
  { 
    ...
    filterType: 'select'  // Shows checkbox list
                ...
                {activeSection === 'selection' && (
                  <div className="space-y-8 animate-fade-in">
                    ...
                    <Card className="paper-aged border-primary/10">
                      <CardHeader>
                        <CardTitle className="font-display text-xl">Selection Modes</CardTitle>
                      </CardHeader>
                      <CardContent>
...
const selectedRows = gridApi.getSelectedRows();`} />
                ...
                {activeSection === 'editing' && (
                  <div className="space-y-8 animate-fade-in">
                    ...
                    <Card className="paper-aged border-primary/10">
                      <CardHeader>
                        <CardTitle className="font-display text-xl">Cell Editors</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <CodeBlock code={`const columns: ColumnDef[] = [
  { 
...
/>`} />
                ...
                {activeSection === 'pinning' && (
                  <div className="space-y-8 animate-fade-in">
                    ...
                    <Card className="paper-aged border-primary/10">
                      <CardHeader>
                        <CardTitle className="font-display text-xl">Pin Columns</CardTitle>
                      </CardHeader>
                      <CardContent>
                        <CodeBlock code={`const columns: ColumnDef[] = [
  { 
